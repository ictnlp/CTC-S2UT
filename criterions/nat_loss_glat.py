...
@register_criterion("nat_loss_glat", dataclass=LabelSmoothedDualImitationCriterionConfig)
class LabelSmoothedDualImitationCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        outputs, glat_info = model(src_tokens, src_lengths, prev_output_tokens, tgt_tokens, glat)
        losses, nll_loss = [], []
