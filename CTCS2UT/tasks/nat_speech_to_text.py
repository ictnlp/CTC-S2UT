...
from CTCS2UT.datasets.nat_speech_to_text_dataset import (
...
class NATSpeechToTextTask(SpeechToTextTask):
    ...
    def build_generator(self, models, args, **unused):
        ...
        from CTCS2UT.generator.s2t_nat_generator import S2TNATGenerator
    ...
    def filter_indices_by_size(
        ...
        for ind in indices:
            ...
            try:
                if src_len * self.args.src_upsample_scale >= tgt_len + 2:
